...
Copy build/libs/ReputationBan-0.16.0.jar to your Paper 26.1.2 plugins directory.
Start Paper with Java 25.
Verify /plugins, /rep version, /rep help, /rep doctor, /rep integrations, /rep support bundle, /reportbad tab completion, /rep audit recent.
