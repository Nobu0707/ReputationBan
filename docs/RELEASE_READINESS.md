...
Use this checklist before treating 0.12.0 as ready for a v1.0.0 candidate.
...
- `./scripts/make-review-archive.sh "Phase 12"` creates an archive.
...
- The support bundle does not contain SQLite DB files, server logs, or webhook URLs.
...
- `build/release/ReputationBan-0.12.0.jar`, `.jar.sha256`, and `ReputationBan-0.12.0-release.zip` exist.
